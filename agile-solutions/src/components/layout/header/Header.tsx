    ...
    return (
        ...
        <>
            ...
            <header className="">
                ...
                <nav className="">
                    <div className="flex space-x-3 max-w-7xl m-auto items-center">
                        ...
                        <div className="flex flex-1 items-center py-5" id="">
                            <ul className="flex flex-1 space-x-2">
                                <li className="nav-item">
                                    <a className="text-sm  hover:bg-amber-100/50  rounded-2xl transition duration-300" aria-current="page" href="#">Home</a>
                                </li>
                                <li className="nav-item">
                                    <a className="text-sm hover:bg-amber-100/50  rounded-2xl transition duration-300" href="">Sobre Nos</a>
                                </li>
                                <li className="nav-item">
                                    <a className="text-sm hover:bg-amber-100/50  rounded-2xl transition duration-300" href="#">Serviços</a>
                                </li>
                                <li className="nav-item">
                                    <a className="text-sm hover:bg-amber-100/50  rounded-2xl transition duration-300" href="#">Contacto</a>
                                </li>
                            ...
                            <div className="">
                                <div className="flex space-x-3">
                                    ...
                                    <a className="btn-contact text-sm" href="tel:+244935378674">
                                        <i className="fa-light fa-phone"></i> ligue para nós: +244 935 378 674
